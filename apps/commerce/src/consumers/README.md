...
- `appointment.cancelled (void an unpaid invoice)`
- `consultation.completed (generate the invoice from feeSnapshot)`
- `prescription.signed (make it available at the counter, no stock movement)`
