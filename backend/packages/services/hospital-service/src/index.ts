...
/**
 * @fileoverview Hospital Service
 * @description Hospital Management Service - Hospital and department data
 */

import express, { type Express } from 'express';
import { createLogger } from '@hms/common-logging';
import { errorHandler, extractUser } from '@hms/common-middleware';
...
app.use('/hospitals/:hospitalId/departments', departmentRoutes);
...
if (process.env.NODE_ENV !== 'test') {
  app.listen(PORT, () => {
    logger.info('Hospital service started', {
      port: PORT,
